        ...
        <div class="aunif hisupervisorInput">
                ...
                <el-row>
                    <el-col :span="24">
                        <div class="martexts flexphone flexInput">
                            <p>标题：</p>
                            <el-input style="width: 400px" size="medium" v-model="usertitle" placeholder="请输入内容">
                            </el-input>
                        </div>
            ...
            <div class="admreviewerss" v-if="this.insured_type == 1">
                <el-row>
                    <el-col :span="12">
                        <div class="martexts flexphone">
                            <el-button class="tianbtn" type="primary" @click.prevent="anniu(-1)">填写核实</el-button>
                        </div>
                        <el-form ref="cardForm" :model="usernamesfz" style="width: 540px" size="medium">
                            <el-form-item label="姓名：" :required="true">
                                <el-input v-model="usernamesfz.name" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="性别：">
                                <el-input v-model="usernamesfz.sex" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="出生日期：">
                                <el-input v-model="usernamesfz.csdate" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="身份证号码：">
                                <el-input v-model="usernamesfz.idcard" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="住址：">
                                <el-input type="textarea" :autosize="{ minRows: 3 }" v-model="usernamesfz.address"
                  ...
                  >
                                ...
                                <span class="upload_btn">
                                    <el-upload name="files" :show-file-list="false" :on-success="handlePreview"
                                        action="https://wx.haobofalv.com/api/v1/file/upload" class="elupload">
                                        <el-button class="elupload_bton" size="small" type="primary"
                                            @click.prevent="btnnumber(1)">点击上传</el-button>
                                    </el-upload>
                                </span>
                            </div>
                ...
                >
                  <div slot="error" class="image-slot">
                    <i class="el-icon-picture-outline"></i>
                            ...
                            <Comimageviewer :visible.sync="showViewer" :url="srcListsurl"></Comimageviewer>
                            <div v-for="(item, ind) in usernamesfzimg" :key="ind">
                                <div class="tyetext" v-if="usersrces">
                                    <div class="textwen">
                                        <p class="ptextleis" :title="item.file_name" @click="onopensfz(ind)">
                                            {{ item.file_name }}
                                        </p>
                                        <div class="btntext">
                            ...
                            <div v-for="(item, index) in usercaidfile" :key="index">
                                <div class="tyetext" v-if="filescaid">
                                    <div class="textwen">
                                        <p class="ptextlei" :style="
                        item.path
                          .substring(item.path.lastIndexOf('.') + 1)
                          .toLowerCase() == 'pdf'
                          ? 'color: #5162f8;cursor: pointer;'
                          : 'color:#000'
                      " @click="btnclicks(item.path)" :title="item.file_name">
                                            {{ item.file_name }}
                                        </p>
                                        <div class="btntext">
                                            <a :href="'https://wx.haobofalv.com/' + item.path"
            ...
            <div class="admreviewerss" v-if="this.insured_type == 2">
                <el-row>
                    <el-col :span="14">
                        <div class="martexts flexphone">
                            <el-button class="tianbtn" type="primary" @click.prevent="anniu(0)">填写核实</el-button>
                        </div>
                        <el-form ref="userblicense" :model="userblicense" style="width: 540px" size="medium">
                            <el-form-item label="单位名称:" :required="true">
                                <el-input v-model="userblicense.company" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="地址:">
                                <el-input type="textarea" :autosize="{ minRows: 3 }" v-model="userblicense.adress"
                                    placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="实收资本:">
                                <el-input v-model="userblicense.paidup" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="成立日期:">
                                <el-input v-model="userblicense.blishment" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="有效期:">
                                <el-input v-model="userblicense.validity" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="法人:">
                                <el-input v-model="userblicense.legal" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="注册资本:">
                                <el-input v-model="userblicense.register" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="登记机关:">
                                <el-input v-model="userblicense.authority" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="社会信用代码:">
                                <el-input v-model="userblicense.credit" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="税务登记号:">
                                <el-input v-model="userblicense.taxregis" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="类型:">
                                <el-input v-model="userblicense.deltype" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="组成形式:">
                                <el-input v-model="userblicense.sistion" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="经营范围:">
                                <el-input type="textarea" :autosize="{ minRows: 5 }" v-model="userblicense.business"
                                    placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="证件编号:">
                                <el-input v-model="userblicense.ficate" placeholder="请输入内容"></el-input>
                            </el-form-item>
                        </el-form>
                    </el-col>
                    <el-col :span="10">
                  ...
                  >
                                ...
                                <span class="upload_btn">
                                    <el-upload name="files" :show-file-list="false" :on-success="handlePreview"
                                        action="https://wx.haobofalv.com/api/v1/file/upload" class="elupload">
                                        <el-button class="elupload_bton" size="small" type="primary"
                                            @click.prevent="btnnumber(2)">点击上传</el-button>
                                    </el-upload>
                                </span>
                            </div>
                    ...
                    <i class="el-icon-picture-outline"></i>
                            ...
                            <div v-for="(item, inde) in blisrced" :key="inde">
                                <div class="tyetext" v-if="boolblisrcs">
                                    <div class="textwen">
                                        <p class="ptextleis" :title="item.file_name" @click="onPreview(inde)">
                                            {{ item.file_name }}
                                        </p>
                                        <div class="btntext">
                                            <a :href="'https://wx.haobofalv.com/' + item.path"
            ...
            <div class="admreviewerss">
                <el-row>
                    <el-col :span="12">
                        ...
                        <el-form ref="complaint" :model="complaint" style="width: 540px" size="medium">
                            <el-form-item label="原告姓名：" :required="true">
                                <el-input v-model="complaint.plaintiff" placeholder="请输入内容"></el-input>
                            </el-form-item>
                ...
                ></el-input>
                            ...
                            <el-form-item label="被告姓名：" :required="true">
                                <el-input @input="mattin" v-model="complaint.fendant" placeholder="请输入内容"></el-input>
                            </el-form-item>
                ...
                ></el-input>
                            ...
                            <el-form-item label="案由类型：" :required="true">
                                <el-input v-model="complaint.casetype" placeholder="请输入内容"></el-input>
                  ...
                  >
                            ...
                            <el-form-item label="诉讼请求：" :required="true">
                                <el-input type="textarea" :autosize="{ minRows: 5 }" v-model="complaint.claims"
                                    placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item style="width: 800px" label="请求金额：" :required="true">
                                <el-input style="width: 200px" v-model="complaint.amount"
                                    @blur="inputMoneys($event, 'amount')" @input="userinputmon" size="small"
                                    placeholder="请输入全额"></el-input>
                                元&nbsp;&nbsp;<span style="color: red">{{ plaintrmb }}</span>
                            </el-form-item>
                            <el-form-item label="事实简要陈述：" :required="true">
                                <el-input type="textarea" :autosize="{ minRows: 3 }" v-model="complaint.ocrevidence"
                                    placeholder="请输入内容"></el-input>
                            </el-form-item>
                        ...
                        <div style="padding-left: 50px">
                            <div class="policy">
                                ...
                                <span class="policy_btn" v-if="plaintifftf">
                                    <el-button class="policy_bton" type="primary" :loading="qisloading"
                                        @click.prevent="alldown(3)">全部下载</el-button>
                                </span>
                                <span class="upload_btn">
                                    <el-upload name="files" :show-file-list="false" :on-success="handlePreview"
                                        action="https://wx.haobofalv.com/api/v1/file/upload" class="elupload">
                                        <el-button class="elupload_bton" size="small" type="primary"
                                            @click.prevent="btnnumber(3)">点击上传</el-button>
                                    </el-upload>
                                </span>
                            </div>
                            <!-- <div class="bgimg">
                ...
                >
                  <div slot="error" class="image-slot">
                    <i class="el-icon-picture-outline"></i>
                            ...
                            <!-- 图片 -->
                            <Comimageviewer :visible.sync="plaintiffimg" :url="plaintiffurl"></Comimageviewer>
                            <div v-for="(item, inst) in plaintiffage" :key="inst">
                                <div class="tyetext" v-if="lasrc">
                                    <div class="textwen">
                                        <p class="ptextleis" :title="item.file_name" @click="qisuopenViewer(inst)">
                                            {{ item.file_name }}
                                        </p>
                                        <div class="btntext">
                                            <a :href="'https://wx.haobofalv.com/' + item.path"
            ...
            <div class="admreviewerss">
                <el-row>
                    <el-col :span="12">
                        <div class="martexts flexphone">
                            <el-button class="tianbtn" type="primary" @click.prevent="anniu(2)">填写核实</el-button>
                        </div>
                        <el-form ref="preserveForm" :model="preserveForm" style="width: 540px" size="medium">
                            <el-form-item label="保全申请人：" :required="true">
                                <el-input v-model="preserveForm.preservename" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="保全被申请人：" :required="true">
                                <el-input v-model="preserveForm.preservebei" placeholder="请输入内容"></el-input>
                            </el-form-item>
                ...
                ></el-input>
                            ...
                            <el-form-item style="width: 800px" label="保全金额：" :required="true">
                                <el-input style="width: 200px" v-model="preserveForm.pramount"
                                    @blur="inputMoneyss($event, 'pramount')" @input="userinputmon" size="small"
                                    placeholder="请输入全额"></el-input>
                                元&nbsp;&nbsp;<span style="color: red">{{ pramountrmb }}</span>
                            </el-form-item>
                            <el-form-item label="保全标的：" :required="true">
                                <el-input v-model="preserveForm.presmark" placeholder="请输入内容"></el-input>
                            </el-form-item>
                        </el-form>
                    </el-col>
                    <el-col :span="12">
                        <div style="padding-left: 50px">
                            <div class="policy">
                                ...
                                <span class="policy_btn" v-if="preservationtf">
                                    <el-button class="policy_bton" type="primary" :loading="sqloading"
                                        @click.prevent="alldown(4)">全部下载</el-button>
                                </span>
                                <span class="upload_btn">
                                    <el-upload name="files" :show-file-list="false" :on-success="handlePreview"
                                        action="https://wx.haobofalv.com/api/v1/file/upload" class="elupload">
                                        <el-button class="elupload_bton" size="small" type="primary"
                                            @click.prevent="btnnumber(4)">点击上传</el-button>
                                    </el-upload>
                                </span>
                            </div>
                            <!-- <div class="bgimg">
                ...
                >
                  <div slot="error" class="image-slot">
                    <i class="el-icon-picture-outline"></i>
                            ...
                            <Comimageviewer :visible.sync="preserimg" :url="preserimgurl"></Comimageviewer>
                            <div v-for="(item, inds) in preserimgs" :key="inds">
                                <div class="tyetext" v-if="baosrc">
                                    <div class="textwen">
                                        <p class="ptextleis" :title="item.file_name" @click="bqopenViewer(inds)">
                                            {{ item.file_name }}
                                        </p>
                                        <div class="btntext">
                                            <a :href="'https://wx.haobofalv.com/' + item.path"
                            ...
                            <div>
                                <div class="policy">
                                    <span class="policy_btn" v-if="testimonytf">
                                        <el-button class="policy_bton" type="primary" :loading="zjloading"
                                            @click.prevent="alldown(5)">全部下载</el-button>
                                    </span>
                                    <span class="upload_btn">
                                        <el-upload name="files" :show-file-list="false" :on-success="handlePreview"
                                            action="https://wx.haobofalv.com/api/v1/file/upload" class="elupload">
                                            <el-button class="elupload_bton" size="small" type="primary"
                                                @click.prevent="btnnumber(5)">点击上传</el-button>
                                        </el-upload>
                                    </span>
                                </div>
                        ...
                        <div class="shan" @click="deletes(item.id, item.path)">
                          删除
                                ...
                                <div class="listqishu" v-if="monyimg">
                                    <Comimageviewer :visible.sync="textmonyimg" :url="testmonyurl"></Comimageviewer>
                                    <span class="imgs" v-for="(item, dome) in timonsrc" :key="dome">
                                ...
                                <div class="listqishu" v-if="monyfile">
                                    <span class="imgs" v-for="(item, ins) in timonfile" :key="ins">
                                        <p class="ad_imgs_txt" :style="
                        item.path
                          .substring(item.path.lastIndexOf('.') + 1)
                          .toLowerCase() == 'pdf'
                          ? 'color: #5162f8;cursor: pointer;'
            ...
            <div class="admreviewerss">
                <el-row>
                    <el-col :span="24">
                        <el-form ref="internalForm" :model="internalForm" style="width: 540px" size="medium">
                            <el-form-item label="案件证据：" :required="true">
                                <el-input type="textarea" :autosize="{ minRows: 3 }" v-model="internalForm.evidence"
                                    placeholder="请输入内容"></el-input>
                            </el-form-item>

                            <el-form-item label="同意承保法律依据：" :required="true">
                                <el-input v-model="internalForm.basis" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item label="同意承保备注：" :required="true">
                                <el-input type="textarea" :autosize="{ minRows: 3 }" v-model="internalForm.notes"
                                    placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item style="width: 800px" label="保险金额：" :required="true">
                                <el-input style="width: 200px" v-model="internalForm.coverage"
                                    @blur="inputMoney($event, 'coverage')" @input="userinputmon" size="small"
                                    placeholder="请输入全额"></el-input>
                                元&nbsp;&nbsp;<span style="color: red">{{ fromrmb }}</span>
                            </el-form-item>
                            <el-form-item label="拒绝承保原因：">
                                <el-input type="textarea" :autosize="{ minRows: 3 }" v-model="internalForm.process"
                                    placeholder="请输入内容"></el-input>
                            </el-form-item>
                        </el-form>
                    </el-col>
            ...
            <div class="admreviewerss">
                    ...
                    <el-col :span="24">
                        <el-tabs v-model="activeName">
                            <el-tab-pane label="流程操作" name="first">
                                <div class="tabpane">
                                    <div>
                                        <div style="margin-bottom: 10px" class="nextBtn">上级复核</div>
                                        <div>
                                ...
                                <div class="radiogroup" v-if="feedback == 3">
                                    <div class="textinput">
                                        <div>补充内容：</div>
                                        <el-input style="width: 550px; min-height: 117px; height: 117px" type="textarea"
                                            :autosize="{ minRows: 5 }" :rows="3" placeholder="请输入内容"
                                            v-model="textareas">
                                        </el-input>
                                    </div>
                                </div>
              ...
              > -->
                        ...
                        <!-- 审核按钮 -->
                        <div class="shenhe">
                            <el-button type="primary" @click.prevent="through(1)">确定</el-button>
                            <!-- <el-button
                type="primary"
            ...
            <el-dialog width="90%" center :visible.sync="dialogff" :before-close="handle" :append-to-body="true"
                class="eldisalog">
                <div>
                    <div class="fromrevie">
                        <el-row>
                        ...
                        <el-row class="flexphoneshow">
                                ...
                                <el-tabs style="margin: 0 auto" v-model="activepane">
                                    <el-tab-pane label="文本信息" name="textocr">
                                        <el-carousel :autoplay="false" height="360px">
                                            <el-carousel-item>
                                                <div class="carouselDiv" style="width: 470px"
                                                    v-for="(item, inx) in usernamesfz" :key="inx">
                                                    {{ item }}<br />
                                                </div>
                                            </el-carousel-item>
                                        </el-carousel>
                                    ...
                                    <el-tab-pane label="图片" name="paneimg">
                                        <el-image fit="contain" style="width: 400px; height: 220px" :src="srcs"
                            ...
                            <el-col :span="10">
                                <div class="adminiewrss">
                                    <el-form ref="cardForm" :model="usernamesfz" style="width: 450px" size="medium">
                                        <el-form-item label="姓名：" :required="true">
                                            <el-input v-model="usernamesfz.name" placeholder="请输入内容"></el-input>
                                        </el-form-item>
                                        <el-form-item label="性别：">
                                        ...
                                        <el-form-item label="住址：">
                                            <el-input v-model="usernamesfz.address" placeholder="请输入内容"></el-input>
                                        </el-form-item>
                                    </el-form>
                                </div>
                            </el-col>
                    ...
                    <div class="admreviewerss" v-show="filesstore">
                        <el-row class="flexphoneshow">
                            <el-col :span="14">
                                <el-tabs style="margin: 0 auto" v-model="activepane">
                                    <el-tab-pane label="文本信息" name="textocr">
                                        <el-carousel :autoplay="false" height="460px" style="margin: 0 auto">
                                            <el-carousel-item>
                                                <div class="carouselDiv" style="width: 470px" fit="contain"
                                                    v-for="(item, ind) in indeuserblic" :key="ind">
                                                    {{ item }}<br />
                                                </div>
                                            </el-carousel-item>
                                        </el-carousel>
                                    ...
                                    <el-tab-pane label="图片" name="paneimg">
                                        <el-image fit="contain" style="width: 400px; height: 120px" :src="srcs"
                                            :preview-src-list="srcLists"></el-image>
                                    </el-tab-pane>
                                </el-tabs>
                            </el-col>
                            <el-col :span="10">
                                <div class="adminiewrss">
                                    <el-form ref="userblicense" :model="userblicense" style="width: 450px"
                                        size="medium">
                                        <el-form-item label="单位名称:" :required="true">
                                            <el-input v-model="userblicense.company" placeholder="请输入内容"></el-input>
                                        </el-form-item>
                                        <el-form-item label="地址:">
                                            <el-input v-model="userblicense.adress" placeholder="请输入内容"></el-input>
                                        </el-form-item>
                                        <el-form-item label="实收资本:">
                                            <el-input v-model="userblicense.paidup" placeholder="请输入内容"></el-input>
                                        </el-form-item>
                                        ...
                                        <el-form-item label="经营范围:">
                                            <el-input type="textarea" :autosize="{ minRows: 3 }"
                                                v-model="userblicense.business" placeholder="请输入内容"></el-input>
                                        </el-form-item>
                                        <el-form-item label="证件编号:">
                                            <el-input v-model="userblicense.ficate" placeholder="请输入内容"></el-input>
                                        </el-form-item>
                    ...
                    <div class="admreviewerss" v-show="filesocruse">
                        <el-row class="flexphoneshow">
                            <el-col :span="14">
                                <el-tabs style="width: 587px; margin: 0 auto" v-model="activepane">
                                    <el-tab-pane label="文本信息" name="textocr">
                                        <el-carousel :autoplay="false" height="650px" style="margin: 0 auto">
                                            <el-carousel-item v-for="item in jpgocr" :key="item.id">
                                                <div class="carouselDiv" style="width: 470px" v-html="item"></div>
                                            </el-carousel-item>
                                        </el-carousel>
                                    </el-tab-pane>
                                    ...
                                    <el-tab-pane label="图片" name="paneimg">
                                        <el-carousel :autoplay="false" height="650px" style="margin: 0 auto">
                                            <el-carousel-item>
                                                <div class="carouselDiv" style="width: 470px"
                                                    v-for="(item, ind) in lasrcs" :key="ind">
                            ...
                            <el-col :span="10">
                                <div class="adminiewrss">
                                    <el-form ref="complaint" :model="complaint" height="650px" style="width: 450px"
                                        size="medium">
                                        <el-form-item label="原告姓名：" :required="true">
                                            <el-input v-model="complaint.plaintiff" placeholder="请输入内容"></el-input>
                                        </el-form-item>
                      ...
                      ></el-input>
                                        ...
                                        <el-form-item label="被告姓名：" :required="true">
                                            <el-input @input="mattin" v-model="complaint.fendant" placeholder="请输入内容">
                                            </el-input>
                                        </el-form-item>
                                        <!-- <el-form-item label="被告联系电话：">
                      <el-input
                      ...
                      >
                        ...
                        >
                                        ...
                                        <el-form-item label="诉讼请求：" :required="true">
                                            <el-input type="textarea" :autosize="{ minRows: 3 }"
                                                v-model="complaint.claims" placeholder="请输入内容"></el-input>
                                        </el-form-item>
                                        <el-form-item label="请求金额：" :required="true">
                                            <el-input style="width: 200px" v-model="complaint.amount"
                                                @blur="inputMoneys($event, 'amount')" size="small" placeholder="请输入全额">
                                            </el-input>
                                        </el-form-item>
                                        <el-form-item label="事实简要陈述：" :required="true">
                                            <el-input type="textarea" :autosize="{ minRows: 3 }"
                                                v-model="complaint.ocrevidence" placeholder="请输入内容"></el-input>
                                        </el-form-item>
                                        <!-- <el-form-item label="事实与理由：">
                      <el-input
                        type="textarea"
                    ...
                    <div class="admreviewerss" v-if="filesparese">
                        <el-row class="flexphoneshow">
                            <el-col :span="14">
                                <el-tabs style="width: 587px; margin: 0 auto" v-model="activepane">
                                    <el-tab-pane label="文本信息" name="textocr">
                                        <el-carousel :autoplay="false" height="350px" style="margin: 0 auto">
                                            <el-carousel-item v-for="(item, ind) in ocrprease" :key="ind">
                            ...
                            <el-col :span="10">
                                <div class="adminiewrss">
                                    <el-form ref="preserveForm" :model="preserveForm" style="width: 450px"
                                        size="medium">
                                        <el-form-item label="保全申请人：" :required="true">
                                            <el-input v-model="preserveForm.preservename" placeholder="请输入内容">
                                            </el-input>
                                        </el-form-item>
                                        <el-form-item label="保全被申请人：" :required="true">
                                            <el-input v-model="preserveForm.preservebei" placeholder="请输入内容"></el-input>
                      ...
                      ></el-input>
                                        ...
                                        <el-form-item label="保全金额：" :required="true">
                                            <el-input style="width: 200px" v-model="preserveForm.pramount"
                                                @blur="inputMoneyss($event, 'pramount')" size="small"
                                                placeholder="请输入全额"></el-input>
                                            元
                                        </el-form-item>
                                        <el-form-item label="保全标的：" :required="true">
                ...
                Caserepeat(data).then(res => {
                    if (res.data != null) {
                        ...
                        res.data.forEach(element => {
                            tmp += `<span><a href='/admin/index.html#/usertable/adminfiedlook?data=` +
                                element.id + `' target='_blank'>` + element.number + `</a></span><br>`
                        });
                        this.$notify.close();
