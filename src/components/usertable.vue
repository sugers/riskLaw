    ...
    <div class="usertable">
        <div class="user_data">
            ...
            <div class="radios">
                ...
                <el-select v-model="suosuo" placeholder="请选择" @change="baoselect">
                    <el-option v-for="item in daticcon" :key="item.id" :label="item.name" :value="item.id">
                    </el-option>
                </el-select>
            </div>
            ...
            <div class="radios">
                ...
                <el-select v-model="provincesid" placeholder="请选择" :popper-append-to-body="false">
            ...
            <div class="radios" v-if="chulir">
                ...
                <el-select v-model="userreivws" @change="userreivewer" placeholder="请选择" clearable>
                    <el-option v-for="item in reivewer" :key="item.id" :label="item.name" :value="item.id">
                    </el-option>
                </el-select>
            </div>
            ...
            <div class="radios">
                ...
                <div class="iniconstatur">
                    <el-date-picker v-model="userDateTime" type="daterange" range-separator="至" start-placeholder="开始日期"
            ...
            <div class="scrbtnb">
                <el-button type="info" @click.prevent="deledetabdat" icon="el-icon-refresh">
                    重置
                </el-button>
                <el-button type="primary" @click.prevent="btnsearchclick" icon="el-icon-search">
                    搜索
                </el-button>
            </div>
        </div>
        ...
        >
          刷新
                ...
                <el-button v-if="adminuserbtn" type="text" style="background-color: #f56c6c"
                    @click.prevent="userdatabtn" icon="el-icon-delete">
                    批量删除
                </el-button>
                <el-button v-if="userdatabottom && radiocyt == 3" type="text" style="background-color: #409eff"
                    @click.prevent="downloadThelaw" icon="el-icon-download" :loading="userdownload">
                    批量下载法律意见书
                </el-button>
                <el-upload v-if="andfinance && radiocyt == 3" name="file" :show-file-list="false"
                    :on-success="batchsheetxlxsfile" :before-upload="beforeUpload" :on-error="onerror"
                    action="https://wx.haobofalv.com/api/v1/admin/review/case/batch_modify_trade" :headers="access"
                    class="andfinance">
                    <el-button type="primary" icon="el-icon-upload">批量出单</el-button>
                </el-upload>
            </div>
            <el-table ref="tableref" :header-cell-style="headertextAlgin" :cell-style="celltextAlgin" :data="tableData"
                style="width: 100%" @selection-change="handleSelectionChange" :row-class-name="tablerowclassname">
                <el-table-column type="selection" width="55">
                </el-table-column>
                <el-table-column type="index" :index="indexMethos" width="55" label="序号">
                </el-table-column>
                ...
                <el-table-column prop="application_time" label="申请时间" min-width="150">
                </el-table-column>
                <el-table-column prop="icco_name" label="保险总司" min-width="160" align="center" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="area_name" label="区域" min-width="80">
                </el-table-column>
                <el-table-column prop="status" label="状态" min-width="100">
                </el-table-column>
                <el-table-column prop="review_result" label="当前评估结果" min-width="120">
            ...
            <div class="paginat">
                <el-pagination class="paginastyes" ref="paginatref" background layout="total,sizes,prev,pager, next"
                    @size-change="handsizetext" @current-change="handsizepage" :current-page="currentPage"
                    :page-size="pagesize" :page-sizes="[30, 40, 50]" :total="total">
                </el-pagination>
            </div>
