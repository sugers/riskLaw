            ...
            <div class="insuranceBottom statistic">
                <div class="bottomTable usermanagerFix" style="position: relative">
                    <el-table ref="filterTable" show-summary :summary-method="getSummaries" :data="tableData"
                        ...
                        <el-table-column prop="name" label="公司名称" width="180" align="center" show-overflow-tooltip
                            class-name="grayColor">
                        </el-table-column>
                        <el-table-column prop="total_risk_eval_num" label="评估总数量" width="100" align="center"
                            show-overflow-tooltip
                            class-name="grayColor">
                        </el-table-column>
                        <el-table-column prop="total_risk_eval_amount" label="评估总保额" width="140" align="center"
                            show-overflow-tooltip class-name="grayColor">
                            <template slot-scope="scope">
                                <span>{{ scope.row.total_risk_eval_amount | currency }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="success_risk_eval_num" label="同意数量" width="80" align="center"
                            show-overflow-tooltip
                            class-name="grayColor">
                        </el-table-column>
                        <el-table-column prop="success_risk_eval_amount" label="同意保额" width="140" align="center"
                            show-overflow-tooltip class-name="grayColor">
                            <template slot-scope="scope">
                                <span>{{ scope.row.success_risk_eval_amount | currency }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="refuse_risk_eval_num" label="拒绝数量" width="80" align="center"
                            show-overflow-tooltip
                            class-name="grayColor">
                        </el-table-column>
                        <el-table-column prop="refuse_risk_eval_amount" label="拒绝保额" width="140" align="center"
                            show-overflow-tooltip class-name="grayColor">
                             <template slot-scope="scope">
                                 <span>{{ scope.row.refuse_risk_eval_amount | currency }}</span>
                             </template>
                        </el-table-column>
                        <el-table-column prop="trade_risk_eval_num" label="出单数量" width="80" align="center"
                            show-overflow-tooltip
                            class-name="grayColor">
                        </el-table-column>
                        <el-table-column prop="trade_risk_eval_amount" label="出单保额" width="140" align="center"
                            show-overflow-tooltip class-name="grayColor">
                            <template slot-scope="scope">
                                <span>{{ scope.row.trade_risk_eval_amount | currency }}</span>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
