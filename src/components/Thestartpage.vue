<template>
    <div class="hello">
        ...
        <el-dialog width="45%" center :visible.sync="dialogheades" :before-close="handleClosepass" class="shendialog">
            <div class="gir-text">
                ...
                <el-row class="rows">
                    <el-col :span="24">
                        <div class="instaheades">
                            <div class="headeditList">
                                ...
                                <div class="headlistRight">
                                    <el-input class="inputpass" type="password" v-model="oldpassword"
                            ...
                            <div class="headeditList">
                                ...
                                <div class="headlistRight">
                                    <el-input class="inputpass" type="password" v-model="newpassword"
                                        placeholder="请输入密码"></el-input>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="auditmartexts">
                            ...
                            <el-button type="primary" @click="hearescancel" style="background-color: #d7d7d7">取消
                            </el-button>
                        </div>
                    </el-col>
                </el-row>
