  ...
  <div class="navtab">
    ...
    >
      <el-menu router :default-active="this.$route.path">
        ...
        <el-menu-item
          index="/Financia"
          v-if="(chusheng || baoxtai || baocaiw || pingcaiw) && !isphone"
        >
          <template>
        ...
        <el-submenu index="" v-if="!isphone">
          ...
          >
          <el-menu-item
            v-if="chusheng || pingtaishen || pingcaiw"
            index="/laywerWorkload"
            >法务人员工作量表
          </el-menu-item>
          <el-menu-item
            v-if="baoxtai || chusheng || baocaiw"
            index="/Statistics"
            >业务人员业绩表</el-menu-item
          >
          <el-menu-item v-if="chusheng || pingcaiw" index="/layweroverTable"
            >业务发展总览表</el-menu-item
          >
          <el-menu-item
            v-if="baoxtai || chusheng || baocaiw"
            index="/OverviewTable"
          ...
          >
          <el-menu-item
            v-if="pingtaishen || baoxtai || chusheng || pingcaiw"
            index="/TrendChart"
            >业务发展趋势图
          </el-menu-item>
        </el-submenu>
        ...
        <el-menu-item index="/CasetypeAdmin" v-if="chusheng">
          <template slot="title">
