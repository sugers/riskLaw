          ...
          <div class="companySelect onlyClass">
            ...
            <div class="selectContent">
              <el-select
                ...
                slot="prepend"
                placeholder="请选择"
                @change="insuranceSelect"
              >
                <el-option
                  v-for="(item, index) in insuranceDta"
                  :key="index"
                  :label="item.name"
                  :value="item.code"
                >
          ...
          >
            ...
            <el-table-column width="60">
              ...
              <template slot-scope="scope">
                <div
                  :class="scope.row.status === 1 ? 'BoldColor' : 'diabledColor'"
                >
            ...
            >
              <template slot-scope="scope">
                <el-button
                  type="primary"
                  size="small"
                  @click="buttonClick('编辑', scope.row)"
                  >编辑
                </el-button>
                <el-button
                  type="danger"
                  size="small"
                  @click="buttonClick('删除', scope.row)"
                  >删除
                </el-button>
              </template>
            </el-table-column>
...
import { getDateString } from "../../../static/js/timeFormat";
      ...
      Getuser(data).then((res) => {
        if (res.code == 200) {
          res.data.accounts.map((item) => {
            ...
            provinces.forEach((areaitem) => {
              if (item.area_name == areaitem.code && item.area_name != 0) {
